...
function ModeratorManagement() {
    ...
    const handleCreateModerator = async () => {
        ...
        try {
            ...
            await axios.put('http://localhost:8080/moderator/0', data, {
                headers: {
        ...
        <div className="container mx-auto px-4 py-8 flex flex-col items-center">
            ...
            <div className="w-full max-w-md">
                <div className="flex flex-col mb-4">
                    ...
                    <button onClick={handleCreateModerator} className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Update Moderator</button>
                </div>
            </div>
